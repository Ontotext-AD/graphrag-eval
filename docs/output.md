...
Function `compute_aggregates()` takes in the computed evaluation metrics and aggregates them. These aggregate metrics allow comparison of analysis of agent (answering system) quality, variability, token efficiency and execution performance.
