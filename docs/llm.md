...
The following metrics use an LLM which must be configured using a [configuration](https://github.com/Ontotext-AD/graphrag-eval/blob/main/docs/config.md) file:
- answer metrics
  - `answer_recall`
  - `answer_precision`
  - `answer_f1`
