...
1. Steps score: correctness of the agent's steps in responding to a user query (`steps_score`) (section [Steps score](https://github.com/Ontotext-AD/graphrag-eval/blob/main/docs/steps.md#steps-score))
1. Vector retrieval
    ...
    1. IDs: Recall, precision, F1 of retrieved chunk IDs with respect to the reference chunk IDs (`retrieval_chunk_ids_recall`, `retrieval_chunk_ids_precision`, `retrieval_chunk_ids_f1`) (section [Retrieval evaluation using chunk IDs](https://github.com/Ontotext-AD/graphrag-eval/blob/main/docs/retrieval-ids.md))
...
1. Custom metrics defined by the user (section [Custom evaluation](https://github.com/Ontotext-AD/graphrag-eval/blob/main/docs/custom.md))

Each metric has required reference and target data types; it is computed if those data are among the supplied reference answer data and the actual answer data. The output for each question includes keys for metrics and other data, listed in section [Output](https://github.com/Ontotext-AD/graphrag-eval/blob/main/docs/output.md).
