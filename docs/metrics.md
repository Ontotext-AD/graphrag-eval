...
1. Vector retrieval
    ...
    1. IDs: Recall, precision, F1 of retrieved chunk IDs with respect to the reference chunk IDs (`retrieval_chunk_ids_recall`, `retrieval_chunk_ids_precision`, `retrieval_chunk_ids_f1`) ([§ Retrieval evaluation using chunk IDs](https://github.com/Ontotext-AD/graphrag-eval/blob/main/docs/retrieval-ids.md))
