...
def test_do_times_equal(anchor_time: datetime, p1, p2, match: bool):
    assert do_times_equal(anchor_time, p1, p2) == match
    assert do_times_equal(anchor_time, p2, p1) == match
