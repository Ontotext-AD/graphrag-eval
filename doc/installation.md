...
To evaluate answer relevance and answer correctness or use a [custom evaluation](https://github.com/Ontotext-AD/graphrag-eval/blob/main/custom-evaluation.md):
