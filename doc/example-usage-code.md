...
`evaluation_results` is a list of statistics for each question, as in section [Evaluation Results](https://github.com/Ontotext-AD/graphrag-eval/blob/main/doc/evaluation-output.md). The format is explained in section [Output Keys](https://github.com/Ontotext-AD/graphrag-eval/blob/main/doc/output-keys.md)
